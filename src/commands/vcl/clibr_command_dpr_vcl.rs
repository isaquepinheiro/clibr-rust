...
#[derive(Default)]
pub struct CommandGenerateProjectVCL {}

impl CommandGenerateProjectVCL {
    pub fn new() -> Self {
        Self {}
    }
}

impl ICommand for CommandGenerateProjectVCL {
    fn execute(&self, _dir_name: &str, _file_name: &str, _cli: &mut dyn ICli) -> bool {
        ...
        let template_file_path: String = format!("{}/vcl.project.pas", _cli.get_path_temp());
