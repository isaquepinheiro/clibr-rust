...
impl ICommand for CommandInfo {
    fn execute(&self, _dir_name: &str, _file_name: &str, _cli: &mut dyn ICli) -> bool {
        let print_text: ListText = vec![
            "".to_string(),
            " ______   ____    ____  ________  ______              ______  _____     _____  ".to_string(),
            "|_   _ `. |_  \\  /   _||_   __  ||_   _ \\           .\' ___  ||_   _|   |_   _| ".to_string(),
            "  | | `. \\ |   \\/   |    | |_ \\_|  | |_) | _ .--.  / .\'   \\_|  | |       | |   ".to_string(),
            "  | |  | | | |\\  /| |    |  _|     |  __\'.[ `/\'`\\] | |         | |   _   | |   ".to_string(),
            " _| |_.\' /_| |_\\/_| |_  _| |_     _| |__) || |     \\ `.___.\'\\ _| |__/ | _| |_  ".to_string(),
            "|______.\'|_____||_____||_____|   |_______/[___]     `.____ .\'|________||_____| ".to_string(),
            "".to_string(),
