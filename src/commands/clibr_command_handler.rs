...
#[derive(Default)]
pub struct CommandRouteHandler {}

impl CommandRouteHandler {
    pub fn new() -> Self {
        Self {}
    }
}

impl ICommand for CommandRouteHandler {
    fn execute(&self, _dir_name: &str, _file_name: &str, _cli: &mut dyn ICli) -> bool {
        ...
        let template_file_path: String = format!("{}/handler.pas", _cli.get_path_temp());
